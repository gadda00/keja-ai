...
| Client desk holds two further live mandates not represented in inventory      | P1       | KJA-024 Daykio Kiragu 5BR (KES 67M) + KJA-025 Kantafu 30 acres (KES 5.5M/acre) added with owner photos; verification honestly `pending`                                                  |
