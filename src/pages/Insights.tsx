      ...
      <section className="bg-ink py-20 sm:py-24">
        <div className="container-luxe max-w-3xl text-center">
          ...
          <p className="mt-6 leading-relaxed text-white/65">
            The right property. The right location. The right strategy. Keja’s market desk distils what matters
            for Kenyan buyers and investors — no hype, no fear-selling, just durable principles.
          </p>
        </div>
      </section>
        ...
        <div className="container-luxe">
          <motion.div {...fadeUp} className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 italic text-ink-muted">
              &ldquo;The people who wait for a place to become expensive usually fund the profits of those who entered
              early.&rdquo;
            </p>
          </motion.div>
          <div className="mt-12 grid gap-6 grid-cols-1 md:grid-cols-3">
            {[
              ...
              { title: 'Timing', text: 'Enter early, stay ahead, and let time build your wealth. Growth corridors sell at entry prices only once — the goal is to buy the corridor before the ribbon-cutting, not after.' },
            ].map((p, i) => (
              <motion.div key={p.title} {...fadeUp} transition={{ ...fadeUp.transition, delay: i * 0.08 }} className="card-luxe p-7 text-center">
        ...
        <div className="container-luxe text-center">
          <motion.div {...fadeUp}>
            <h2 className="font-display text-2xl font-bold text-white sm:text-4xl">
              Want these principles applied to <span className="gold-text">your</span> next property?
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-white/60">
              Ask Keja for a personalised investor report: property & location analysis, yield, ROI, 5/10-year
              projections, risks, strengths and a plain-language verdict — built on verified inventory.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link to="/ask" className="btn-gold">Get my investor report <ArrowRight className="h-4 w-4" /></Link>
              <Link to="/invest" className="inline-flex items-center gap-2 border border-gold-400/50 px-6 py-3 text-sm font-semibold text-gold-300 transition hover:bg-gold-400/10">
                Open the calculator
              </Link>
            </div>
          </motion.div>
