      ...
      <div className="container-luxe py-14 sm:py-20">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 leading-relaxed text-ink-muted">
            Whether you’re buying, selling, investing or want to onboard your agency onto the Keja network —
            we reply fast, and clearly. No pressure, ever. That’s the house rule.
          </p>
        </div>
          ...
          <div className="card-luxe p-6 sm:p-8">
            {sent ? (
              <div className="py-10 text-center">
                ...
                <h2 className="mt-4 font-display text-2xl font-bold text-ink">Message received — asante sana!</h2>
                <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-ink-muted">
                  {form.name.split(' ')[0]}, your enquiry is in the pipeline and a member of our team will respond
                  within one business day. Anything urgent? Keja answers instantly, around the clock.
                </p>
                <div className="mt-6 flex flex-wrap justify-center gap-3">
                  <Link to="/ask" className="btn-gold"><Bot className="h-4 w-4" /> Chat with Keja</Link>
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select value={form.interest} onChange={(e) => setForm({ ...form, interest: e.target.value })} className="input-luxe">
                ...
                <div>
                  ...
                  <textarea required rows={5} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className="input-luxe resize-none" placeholder="Tell us what you need — budget, areas, timeline. Keja will prep answers before we call." />
                </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-ink-muted">Instant answers, viewing requests, escrow prompts. Kenya’s channel.</p>
              </div>
            </a>
            ...
            <Link to="/ask" className="card-luxe card-luxe-hover flex items-center gap-4 p-6">
              ...
              <div>
                ...
                <p className="text-sm text-ink-muted">Property search, investment math, trust checks — instantly, in 3 languages.</p>
              </div>
            </Link>
            ...
            <div className="card-luxe p-6">
              ...
              <div className="mt-5 rounded-xl bg-gold-50 p-4 text-xs leading-relaxed text-ink-soft">
                <b>Keja.ai</b> is a Chacadom Investments venture. For investment advisory, joint ventures and
                portfolio management, our Chacadom desk handles institutional enquiries.
              </div>
            </div>
