...
describe('calculateMortgage', () => {
  ...
  it('extra payments save interest and months', () => {
    ...
    if (!extra.extra) throw new Error('expected extra payments breakdown to be defined');
...
describe('calculateAffordability', () => {
  it('caps instalment at 33% DTI minus obligations', () => {
    const a = calculateAffordability({
      netMonthlyIncome: 300_000,
      otherMonthlyObligations: 30_000,
      annualRatePct: 13.5,
      termYears: 15,
      depositPct: 20,
    });
  ...
  it('never returns negative capacity', () => {
    const a = calculateAffordability({
      ...
      otherMonthlyObligations: 40_000,
      annualRatePct: 14,
      termYears: 10,
      depositPct: 10,
    });
