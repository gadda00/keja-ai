...
export const ARTICLES: Article[] = [
  {
    ...
    excerpt: 'From offer to keys — every stage, cost and document in one honest walkthrough, including Ardhisasa transfer mechanics.',
    ...
    blocks: [
      ...
      { quote: 'The buyers who lose money in Kenya are almost never the victims of exotic fraud — they are the people who skipped a KES 500 search to save time on a KES 10,000,000 decision.' },
    ],
  },
  {
    slug: 'diaspora-buying-kenya-safely',
    title: 'Diaspora guide: buying Kenyan property from abroad without losing your shirt',
    excerpt: 'The five failure modes that burn diaspora buyers — and the escrow, verification and management structures that prevent each one.',
    category: 'Diaspora',
    minutes: 8,
    date: '2026-08-12',
    author: 'Keja Market Desk',
    blocks: [
      ...
      { quote: 'Distance is not the risk. Unverified distance is. Every structure in this guide is just a way of making the far away behave like the near.' },
    ],
  },
  {
    slug: 'kenyan-mortgages-2026-explained',
    title: 'Kenyan mortgages in 2026: rates, deposits and what banks actually approve',
    excerpt: 'Why the average Kenyan mortgage rate sits where it does, how the 33% debt-to-income rule prices your ceiling, and how to cut years off the loan.',
    ...
    blocks: [
      ...
      { quote: 'A mortgage is not a product you are approved for. It is a math problem you are either winning or losing, one month at a time.' },
    ],
  },
  {
    slug: 'tokenization-explained-plain-language',
    title: 'Real estate tokenization, explained in plain language',
    excerpt: 'What it actually means to own 500 tokens of a Nairobi tower — the SPV, the ledger, the distributions and the honest limits of the 2026 Kenyan regulatory scene.',
    category: 'Investing',
    minutes: 10,
    date: '2026-07-28',
    ...
    blocks: [
      ...
      { quote: 'Tokenization does not make a bad building good. It makes a good building divisible — which is a completely different promise.' },
    ],
  },
  {
    slug: 'how-keja-verifies-listings',
    title: 'Inside the Keja trust layer: how a listing earns the Verified badge',
    excerpt: 'Ardhisasa cross-checks, photo forensics, duplicate-signature detection and price anomaly bands — the five signals behind every trust score.',
    ...
    blocks: [
      ...
      { quote: 'We show you flagged listings on purpose, clearly labelled. A marketplace that only shows you what it approved is asking for faith. We prefer to show you the machinery.' },
    ],
  },
  {
    slug: 'nairobi-growth-corridors-2026',
    title: 'Nairobi\u2019s growth corridors 2026: where infrastructure is quietly repricing land',
    excerpt: 'Expressway spillovers, SGR satellite towns and the Ruaka–Kileleshwa value gradient — a data-grounded tour of where the tarmac is going next.',
    category: 'Market Notes',
    minutes: 8,
    date: '2026-07-10',
    author: 'Keja Market Desk',
