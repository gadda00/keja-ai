...
export const areaInsights: Record<string, { avgPricePerSqm: string; yield: string; note: string }> = {
  ...
  Runda: { avgPricePerSqm: 'KES 175k–195k', yield: '5–6%', note: 'Diplomatic address; protected by controlled development.' },
  ...
  Ruaka: { avgPricePerSqm: 'KES 88k–96k', yield: '9%+', note: 'Northern growth node; Two Valley Mall effect.' },
  'Athi River': { avgPricePerSqm: 'KES 3.2M–3.9M per 1/4 acre', yield: 'Land play', note: 'EPZ + industrial expansion; strong land appreciation.' },
