import { Home, Mail, MapPin, Phone, ShieldCheck } from 'lucide-react';
    ...
    <footer className="border-t border-gold-100 bg-ink text-white/80">
      <div className="container-luxe grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/60">
            {SITE.tagline} Kenya’s AI real-estate advisor and cross-agency trust layer — discovery,
            advisory, verification and management in one flow.
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            ...
            <li>
              <Link to="/invest" className="hover:text-gold-300">
                Investment Calculator
              </Link>
            </li>
            <li>
              <Link to="/ask" className="hover:text-gold-300">
                Ask Keja AI
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/partners" className="hover:text-gold-300">
                Partner Network
              </Link>
            </li>
            <li>
              <Link to="/ecosystem" className="hover:text-gold-300">
                The Ecosystem
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h4 className="text-xs font-bold uppercase tracking-wide2 text-gold-400">
            Trust & Company
          </h4>
          <ul className="mt-4 space-y-2.5 text-sm">
            <li>
              <Link to="/trust" className="hover:text-gold-300">
                Trust Center
              </Link>
            </li>
            <li>
              <Link to="/legal" className="hover:text-gold-300">
                Terms &amp; Privacy
              </Link>
            </li>
            <li>
              <Link to="/trust#score" className="hover:text-gold-300">
            ...
            <li>
              <Link to="/manage" className="hover:text-gold-300">
                List & Manage
              </Link>
            </li>
            <li>
              <Link to="/account" className="hover:text-gold-300">
                My Account
              </Link>
            </li>
            <li>
              <Link to="/admin" className="hover:text-gold-300">
                Admin Console
              </Link>
            </li>
          </ul>
      ...
      <div className="border-t border-white/10">
        <div className="container-luxe flex flex-col items-center justify-between gap-3 py-5 text-xs text-white/50 sm:flex-row">
          <p>
            © {new Date().getFullYear()} Keja.ai — a Chacadom Investments venture. All rights
            reserved.
          </p>
