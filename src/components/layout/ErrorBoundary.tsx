      ...
      return (
        <div className="container-luxe flex min-h-[70vh] flex-col items-center justify-center py-20 text-center">
          ...
          <p className="mt-3 max-w-md text-sm leading-relaxed text-ink-muted">
            An unexpected error occurred while rendering this page. Your data is safe — reloading
            usually resolves it. If it persists, our team would appreciate the details.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <button onClick={() => window.location.reload()} className="btn-gold">
              Reload page
            </button>
            <a href={import.meta.env.BASE_URL} className="btn-outline-luxe">
              Back to home
            </a>
          </div>
          <p
            className="mt-6 max-w-lg truncate rounded-lg bg-cream px-3 py-2 font-mono text-[11px] text-ink-faint"
            role="note"
          >
